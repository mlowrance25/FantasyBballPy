...
from fantasy_analyer import PositionDict,TeamDict,ScoringDict,DraftKingPriceDict,FanduelPriceDict,YesterdaysTeam,TeamsPlayingDict
import database
...
class PlayerStats:
    ...
    def addPlayerStat(self,playerId,playnerName,positionId,teamId,opponentId,totalPt,threePtsMade,rebounds,assist,steal,turnover,block):
        ...
        if self.numGameFilter == 999 or self_playerDict[playerId].numStats < self.numGameFilter:
...
class PlayerStatEntry:
    ...
    def getFantasyScore(self,fantasyId):
        ...
        total += self.avgThreePtsMade * currenScoring[2]
